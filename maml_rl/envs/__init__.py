...
register(
    'HalfCheetahDirBullet-v0',
    entry_point='maml_rl.envs.utils:mujoco_wrapper',
    kwargs={'entry_point': 'maml_rl.envs.pybullet.half_cheetah_env:HalfCheetahDirEnv'},
    max_episode_steps=200
)
register(
    'HalfCheetahVelBullet-v0',
    entry_point='maml_rl.envs.utils:mujoco_wrapper',
    kwargs={'entry_point': 'maml_rl.envs.pybullet.half_cheetah_env:HalfCheetahVelEnv'},
    max_episode_steps=200
)
register(
    'AntVelBullet-v0',
    entry_point='maml_rl.envs.utils:mujoco_wrapper',
    kwargs={'entry_point': 'maml_rl.envs.pybullet.ant_env:AntVelEnv'},
    max_episode_steps=200
)
register(
    'AntDirBullet-v0',
    entry_point='maml_rl.envs.utils:mujoco_wrapper',
    kwargs={'entry_point': 'maml_rl.envs.pybullet.ant_env:AntDirEnv'},
    max_episode_steps=200
)
register(
    'AntPosBullet-v0',
    entry_point='maml_rl.envs.utils:mujoco_wrapper',
    kwargs={'entry_point': 'maml_rl.envs.pybullet.ant_env:AntPosEnv'},
    max_episode_steps=200
)
